module.exports = {
	...
	hex32String: function (arr, start) {
		...
		return String.fromCharCode(parseInt(arr[start], 16)) + String.fromCharCode(parseInt(arr[start + 1], 16)) + String.fromCharCode(parseInt(arr[start + 2], 16)) + String.fromCharCode(parseInt(arr[start + 3], 16))
	},
